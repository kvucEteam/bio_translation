    ...
    $(".draggable_tRNA").draggable({
        ...
        revert: function(valid) {
            ...
            if (valid) {
                ...
                $(".score_cont").html("Score: " + score + " / " + Math.round(dObj.codonArr.length / 2));
...
console.log("arrayElementInArray([[1,2,3], ['A','C','G','U'], [1,'a',2,'b']], [1,'a',2,'b']): " + arrayElementInArray([
    [1, 2, 3],
    ['A', 'C', 'G', 'U'],
    [1, 'a', 2, 'b']
], [1, 'a', 2, 'b']));
console.log("arrayElementInArray([[1,2,3], ['A','C','G','U'], [1,'a',2,'b']], [1,'a','b',2]): " + arrayElementInArray([
    [1, 2, 3],
    ['A', 'C', 'G', 'U'],
    [1, 'a', 2, 'b']
], [1, 'a', 'b', 2]));
console.log("arrayElementInArray([[1,2,3], ['A','C','G','U'], [1,'a',2,'b']], [1,'a',2]): " + arrayElementInArray([
    [1, 2, 3],
    ['A', 'C', 'G', 'U'],
    [1, 'a', 2, 'b']
], [1, 'a', 2]));
